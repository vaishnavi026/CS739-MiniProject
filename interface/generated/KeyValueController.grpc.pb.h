...
#ifndef GRPC_KeyValueController_2eproto__INCLUDED
#define GRPC_KeyValueController_2eproto__INCLUDED
 ...
 public:
  ...
  class StubInterface {
   public:
    ...
    virtual ::grpc::Status Get(::grpc::ClientContext* context, const ::KVStore::GetRequest& request, ::KVStore::GetReponse* response) = 0;
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::KVStore::GetReponse>> AsyncGet(::grpc::ClientContext* context, const ::KVStore::GetRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::KVStore::GetReponse>>(AsyncGetRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::KVStore::GetReponse>> PrepareAsyncGet(::grpc::ClientContext* context, const ::KVStore::GetRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::KVStore::GetReponse>>(PrepareAsyncGetRaw(context, request, cq));
    }
    class async_interface {
     public:
      ...
      virtual void Get(::grpc::ClientContext* context, const ::KVStore::GetRequest* request, ::KVStore::GetReponse* response, std::function<void(::grpc::Status)>) = 0;
      virtual void Get(::grpc::ClientContext* context, const ::KVStore::GetRequest* request, ::KVStore::GetReponse* response, ::grpc::ClientUnaryReactor* reactor) = 0;
    };
   ...
   private:
    ...
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::KVStore::GetReponse>* AsyncGetRaw(::grpc::ClientContext* context, const ::KVStore::GetRequest& request, ::grpc::CompletionQueue* cq) = 0;
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::KVStore::GetReponse>* PrepareAsyncGetRaw(::grpc::ClientContext* context, const ::KVStore::GetRequest& request, ::grpc::CompletionQueue* cq) = 0;
  };
  class Stub final : public StubInterface {
   public:
    ...
    ::grpc::Status Get(::grpc::ClientContext* context, const ::KVStore::GetRequest& request, ::KVStore::GetReponse* response) override;
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::KVStore::GetReponse>> AsyncGet(::grpc::ClientContext* context, const ::KVStore::GetRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::KVStore::GetReponse>>(AsyncGetRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::KVStore::GetReponse>> PrepareAsyncGet(::grpc::ClientContext* context, const ::KVStore::GetRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::KVStore::GetReponse>>(PrepareAsyncGetRaw(context, request, cq));
    }
    class async final :
     ...
     public:
      ...
      void Get(::grpc::ClientContext* context, const ::KVStore::GetRequest* request, ::KVStore::GetReponse* response, std::function<void(::grpc::Status)>) override;
      void Get(::grpc::ClientContext* context, const ::KVStore::GetRequest* request, ::KVStore::GetReponse* response, ::grpc::ClientUnaryReactor* reactor) override;
     private:
      friend class Stub;
   ...
   private:
    ...
    ::grpc::ClientAsyncResponseReader< ::KVStore::GetReponse>* AsyncGetRaw(::grpc::ClientContext* context, const ::KVStore::GetRequest& request, ::grpc::CompletionQueue* cq) override;
    ::grpc::ClientAsyncResponseReader< ::KVStore::GetReponse>* PrepareAsyncGetRaw(::grpc::ClientContext* context, const ::KVStore::GetRequest& request, ::grpc::CompletionQueue* cq) override;
  ...
  class Service : public ::grpc::Service {
   public:
    ...
    virtual ::grpc::Status Get(::grpc::ServerContext* context, const ::KVStore::GetRequest* request, ::KVStore::GetReponse* response);
  };
  ...
  class WithAsyncMethod_Get : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status Get(::grpc::ServerContext* /*context*/, const ::KVStore::GetRequest* /*request*/, ::KVStore::GetReponse* /*response*/) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
    void RequestGet(::grpc::ServerContext* context, ::KVStore::GetRequest* request, ::grpc::ServerAsyncResponseWriter< ::KVStore::GetReponse>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
   ...
   public:
    WithCallbackMethod_Get() {
      ::grpc::Service::MarkMethodCallback(1,
          new ::grpc::internal::CallbackUnaryHandler< ::KVStore::GetRequest, ::KVStore::GetReponse>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::KVStore::GetRequest* request, ::KVStore::GetReponse* response) { return this->Get(context, request, response); }));}
    void SetMessageAllocatorFor_Get(
        ::grpc::MessageAllocator< ::KVStore::GetRequest, ::KVStore::GetReponse>* allocator) {
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::GetHandler(1);
      static_cast<::grpc::internal::CallbackUnaryHandler< ::KVStore::GetRequest, ::KVStore::GetReponse>*>(handler)
              ->SetMessageAllocator(allocator);
    }
    ...
    virtual ::grpc::ServerUnaryReactor* Get(
      ::grpc::CallbackServerContext* /*context*/, const ::KVStore::GetRequest* /*request*/, ::KVStore::GetReponse* /*response*/)  { return nullptr; }
  };
   ...
   public:
    WithStreamedUnaryMethod_Get() {
      ::grpc::Service::MarkMethodStreamed(1,
        new ::grpc::internal::StreamedUnaryHandler<
          ::KVStore::GetRequest, ::KVStore::GetReponse>(
            [this](::grpc::ServerContext* context,
                   ::grpc::ServerUnaryStreamer<
                     ::KVStore::GetRequest, ::KVStore::GetReponse>* streamer) {
    ...
    // replace default version of method with streamed unary
    virtual ::grpc::Status StreamedGet(::grpc::ServerContext* context, ::grpc::ServerUnaryStreamer< ::KVStore::GetRequest,::KVStore::GetReponse>* server_unary_streamer) = 0;
  };
...
#endif  // GRPC_KeyValueController_2eproto__INCLUDED
